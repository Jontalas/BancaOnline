...
},{"axios":"../node_modules/axios/index.js"}],"pages/movements/movements.mapper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapMovementsListApiToVm = exports.mapAccountApiToVm = void 0;
...
var mapMovementsListApiToVm = function mapMovementsListApiToVm(movementsList) {
  return Array.isArray(movementsList) ? movementsList.map(function (movement) {
...
var _movements2 = require("./movements.mapper");
var _movements3 = require("./movements.helpers");
var _helpers = require("../../common/helpers");
var _router = require("../../core/router");
var params = _router.history.getParams();
var accountId = params.id;
var isAccount = Boolean(accountId);
if (isAccount) {
  (0, _account.getAccount)(accountId).then(function (apiAccount) {
    var account = (0, _movements2.mapAccountApiToVm)(apiAccount);
    (0, _helpers.onSetValues)(account);
  });
}
(0, _movements.getMovementsList)(accountId).then(function (apiMovementsList) {
  var movementsList = (0, _movements2.mapMovementsListApiToVm)(apiMovementsList);
  (0, _movements3.addMovementRows)(movementsList);
});
},{"./movements.api":"pages/movements/movements.api.js","../account/account.api":"pages/account/account.api.js","./movements.mapper":"pages/movements/movements.mapper.js","./movements.helpers":"pages/movements/movements.helpers.js","../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
