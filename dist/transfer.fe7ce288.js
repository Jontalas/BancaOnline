...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/transfer/transfer.mapper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapTransferVmToApi = void 0;
var mapTransferVmToApi = function mapTransferVmToApi(transfer) {
  var spacedIban = '';
  for (var i = 0; i < transfer.iban.length; i += 4) {
  ...
  return {
    ...
    date: transfer.year !== '' ? new Date("".concat(transfer.year, "/").concat(transfer.month, "/").concat(transfer.day)).toLocaleDateString() : new Date().toLocaleDateString(),
    email: transfer.email
  };
};
exports.mapTransferVmToApi = mapTransferVmToApi;
...
var _transfer4 = require("./transfer.mapper");
...
(0, _accountList.getAccountList)().then(function (accountList) {
  transfer.alias = (0, _transfer2.setAccountOptions)(accountList, accountId).value;
});
...
var checkValidTransferDate = function checkValidTransferDate() {
  var showError = false;
  if ((transfer.year !== '' || transfer.month !== '' || transfer.day !== '') && (transfer.year === '' || transfer.month === '' || transfer.day === '')) {
    showError = true;
    var result = {
      succeeded: false,
    ...
    var dateString = "".concat(transfer.year, "/").concat(transfer.month, "/").concat(transfer.day);
    ...
    if (showError) {
      ...
      (0, _helpers.onSetError)('date', _result);
    } else {
      var today = new Date();
      ...
      if (todayYear > dateYear || todayYear === dateYear && todayMonth > dateMonth || todayYear === dateYear && todayMonth === dateMonth && todayDay > dateDay) {
        ...
        (0, _helpers.onSetError)('date', _result2);
      }
    }
  }
  return !showError;
...
var onSave = function onSave() {
  var formattedTransfer = (0, _transfer4.mapTransferVmToApi)(transfer);
  return (0, _transfer.insertTransfer)(formattedTransfer);
};
...
},{"../../common/helpers":"common/helpers/index.js","./transfer.api":"pages/transfer/transfer.api.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../account-list/account-list.api":"pages/account-list/account-list.api.js","./transfer.validations":"pages/transfer/transfer.validations.js","./transfer.mapper":"pages/transfer/transfer.mapper.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
